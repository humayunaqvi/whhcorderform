...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/hr/vacations', label: 'Vacations', icon: '✈', roles: ['physician', 'admin', 'clinical'] },
      { href: '/hr/reports', label: 'Payroll Reports', icon: '💰', roles: ['physician', 'admin', 'clinical'] },
      { href: '/hr/writeups', label: 'Write-Ups', icon: '⚠', roles: ['physician', 'admin', 'clinical'] },
      { href: '/hr/announcements', label: 'Manage Announcements', icon: '📣', roles: ['physician', 'admin', 'clinical'] },
      { href: '/hr/documents', label: 'Manage Documents', icon: '📁', roles: ['physician', 'admin', 'clinical'] },
      { href: '/hr/feedback', label: 'Feedback', icon: '💬', roles: ['physician', 'admin', 'clinical'] },
      { href: '/hr/requests', label: 'Requests', icon: '📩', roles: ['physician', 'admin', 'clinical'] },
    ],
  },
  {
    title: 'Education',
